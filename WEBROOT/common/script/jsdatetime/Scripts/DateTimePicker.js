...
var EndYear = 2; // The offset last year of pickable date. If current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var imageFilesPath = "../common/script/jsdatetime/Image/"; //Path of date time picker image files relative to HTML page.
...
var WeekDayName1 = ["CN", "T2", "T3", "T4", "T5", "T6", "T7"];
...
function show_calendar(pCtrl,defDate) {
	//NewCssCal(pCtrl, pFormat, 'dropdown', pShowTime, pTimeMode, pShowSeconds);
	NewCssCal(pCtrl,'ddMMyyyy','dropdown',true,'24',true)
}
