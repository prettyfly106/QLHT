...
<div class="panel panel-default sm">
	<div class="panel-heading"  data-i18n="title">KẾT NỐI BÊN NGOÀI</div>
    <div class="panel-body">    	 
        ...
        <div id="connectInfo">        	
        	<div class="pull-left source-node"  id="couplers_list" ondrop="getSourceBack(event)" ondragover="allowGetSourceBack(event)"></div>        	
        	...
        	<div class="pull-right target-node"  id="cables_list" ondrop="getTargetBack(event)" ondragover="allowGetTargetBack(event)"></div>
			<div class="clearfix"></div>
        </div>
